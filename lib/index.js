(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('framer-motion'), require('react-dom'), require('react-measure'), require('@emotion/styled/base'), require('@emotion/react'), require('react-scrolllock'), require('react-feather/dist/icons/x'), require('react-fixed-bottom'), require('lodash.debounce')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'framer-motion', 'react-dom', 'react-measure', '@emotion/styled/base', '@emotion/react', 'react-scrolllock', 'react-feather/dist/icons/x', 'react-fixed-bottom', 'lodash.debounce'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.reactDynamicSheet = {}, global.React, global.PropTypes, global.framerMotion, global.ReactDOM, global.Measure, global._styled, global.react, global.ScrollLock, global.CloseIcon, global.reactFixedBottom, global.debounce));
}(this, (function (exports, React, PropTypes, framerMotion, ReactDOM, Measure, _styled, react, ScrollLock, CloseIcon, reactFixedBottom, debounce) { 'use strict';

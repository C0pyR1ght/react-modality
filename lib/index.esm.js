...
var ChildrenProps = PropTypes.oneOfType([PropTypes.string, PropTypes.func, PropTypes.node, PropTypes.arrayOf(PropTypes.node)]);
...
var Encapsulate = function Encapsulate(_ref2) {
  ...
  }, rest), /*#__PURE__*/React.createElement(Global, {
    styles: _ref
  }), children);
};
...
Encapsulate.propTypes = {
  ...
  children: PropTypes.oneOfType([PropTypes.string, PropTypes.func, PropTypes.node, PropTypes.arrayOf(PropTypes.node)]).isRequired
};
...
var Frame = /*#__PURE__*/_styled(Encapsulate, process.env.NODE_ENV === "production" ? {
  target: "e1l7d9641"
} : {
  target: "e1l7d9641",
  label: "Frame"
...
var Overlay$1 = _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1l7d9640"
} : {
  target: "e1l7d9640",
  label: "Overlay"
...
var MotionOverlay = motion.custom(Overlay$1);
var Overlay = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
      props = _objectWithoutProperties(_ref, ["children"]);

  return /*#__PURE__*/React.createElement(MotionOverlay, _extends({
    ref: ref,
    variants: {
      hidden: {
...
var DialogBase = function DialogBase(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Frame, props, /*#__PURE__*/React.createElement(ScrollLock, null, children));
};
...
var Button = _styled("button", process.env.NODE_ENV === "production" ? {
  target: "e1q2xf7y0"
} : {
  target: "e1q2xf7y0",
  label: "Button"
...
var Container$1 = _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1w65gh1"
} : {
  target: "e1w65gh1",
  label: "Container"
...
var Body$1 = _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1w65gh0"
} : {
  target: "e1w65gh0",
  label: "Body"
...
var MotionContainer$1 = motion.custom(Container$1);
...
var Modal = function Modal(_ref) {
  ...
  return /*#__PURE__*/ReactDOM.createPortal(isOpen && /*#__PURE__*/React.createElement(DialogBase, null, /*#__PURE__*/React.createElement(Overlay, {
    ...
    return /*#__PURE__*/React.createElement(MotionContainer$1, _extends({
      sx: {
        color: "text",
        bg: "background"
      },
      ...
      ref: measureRef
    }, props), /*#__PURE__*/React.createElement(Close, {
      onClick: onClose
    }), /*#__PURE__*/React.createElement(Body$1, null, /*#__PURE__*/React.createElement("slot", {
...
var Background = _styled("div", process.env.NODE_ENV === "production" ? {
  target: "epq7fa91"
} : {
  target: "epq7fa91",
  label: "Background"
...
var MotionContainer = motion.custom(Container); // Variants and sheet behaviour will change based on the size of the body relative to the viewport
...
var Sheet = function Sheet(_ref) {
  ...
  var onDragEnd = debounce(function (event, info) {
  ...
  return /*#__PURE__*/React.createElement(DialogBase, null, /*#__PURE__*/React.createElement(Overlay, {
    sx: {
      overflow: "hidden !important"
    },
    onClick: onClose
  }, /*#__PURE__*/React.createElement(FixedBottom, null, /*#__PURE__*/React.createElement(MotionContainer, _extends({
    sx: {
      color: "text",
      bg: "white"
    },
  ...
  }, props), /*#__PURE__*/React.createElement(Background, {
...
var BottomSheet = function BottomSheet(_ref2) {
  ...
  return /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(AnimatePresence, null, isOpen && /*#__PURE__*/React.createElement(Sheet, props)), document.body);
};
